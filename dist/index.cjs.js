...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "205", height: "26", href: isDark ? process.env.PUBLIC_URL + "/images/egg/LogoTextNewDark.png" : process.env.PUBLIC_URL + "/images/egg/LogoTextNewWhite.png" })));
};
